...
export const NetZeroFooter: React.FC = () => {
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-[#050505]/80 backdrop-blur-md border-t border-white/10 py-6 px-8 z-40">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2">
           ...
           <div>
              <h4 className="text-sm font-bold uppercase tracking-widest text-emerald-400">Net-Zero Implementation Active</h4>
        ...
        <div className="flex flex-wrap items-center justify-center gap-8">
           ...
           <div className="text-center">
              ...
              <span className="text-2xl font-black text-emerald-400 glow-emerald mono tracking-tighter">$0.00</span>
           </div>
        </div>

        <div className="bg-emerald-500/5 px-6 py-3 rounded-xl border border-emerald-500/20 text-center">
           <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px] uppercase font-bold text-emerald-500">Potential Recovery:</span>
              <span className="text-sm font-black text-emerald-400">$10,751/mo</span>
           </div>
        </div>
      </div>
    </footer>
